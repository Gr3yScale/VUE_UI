...
<template>
  <div class="flex h-full flex-col gap-4 p-4">
    <h2 class="flex-shrink-0 text-sm font-semibold text-compass-heading">Look Up Task</h2>
    <p class="flex-shrink-0 text-xs text-compass-muted">Enter a task ID to view its live status and history.</p>

    <form class="flex flex-1 flex-col gap-3" @submit.prevent="submit">
      <div>
