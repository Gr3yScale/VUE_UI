...
describe('ResultsViewer', () => {
  it('shows loading indicator when isLoading is true', () => {
    const wrapper = mount(ResultsViewer, {
      props: { results: [], isLoading: true, fetchError: null },
    })
  ...
  it('hides loading indicator when not loading', () => {
    const wrapper = mount(ResultsViewer, {
      props: { results: [], isLoading: false, fetchError: null },
    })
  ...
  it('shows error message when fetchError is set', () => {
    const wrapper = mount(ResultsViewer, {
      props: { results: [], isLoading: false, fetchError: 'HTTP 500: Server error' },
    })
  ...
  it('renders a card for each document', () => {
    const wrapper = mount(ResultsViewer, {
      props: { results: sampleDocs, isLoading: false, fetchError: null },
    })
